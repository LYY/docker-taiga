...
if (os.getenv('TAIGA_SSL') is not None and os.getenv('TAIGA_SSL').lower() == 'true') or (os.getenv('TAIGA_SSL_BY_REVERSE_PROXY') is not None and os.getenv('TAIGA_SSL_BY_REVERSE_PROXY').lower() == 'true'):
